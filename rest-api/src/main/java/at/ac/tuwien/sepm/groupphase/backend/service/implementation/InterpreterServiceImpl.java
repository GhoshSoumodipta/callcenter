...
public class InterpreterServiceImpl implements InterpreterService {
    ...
    private  InterpreterMapper interpreterMapper;
...
//        } else
        ...
        Page<InterpreterDTO> result = repository.findByFirstNameContainingIgnoreCase(name, pageable).map(interpreterMapper::entityToDTO);
    ...
    public InterpreterDTO update(InterpreterDTO dto) throws ServiceException {
        ...
        try {
            return interpreterMapper.entityToDTO(repository.save(interpreterMapper.DTOToEntity(dto)));
