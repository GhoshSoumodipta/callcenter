...
public class LocationDTO {
    ...
    @Schema(name = "Locations's name")
    private String locationName;

    @Schema(name = "Location's country")
    private String country;

    @Schema(name = "Location's city")
    private String city;

    @Schema(name = "Location's postal code")
    private String postalCode;

    @Schema(name = "Location's street")
    private String street;

    @Schema(name = "Location's description")
