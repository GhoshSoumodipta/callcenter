...
@Schema(name = "TopTenDetailsDTO", description = "a dto to pass for requests for the top ten events")
public class TopTenDetailsDTO {

    @Schema(name = "the months that is searched for")
    private List<String> months;
    @Schema(name = "the categories that is searched for")
