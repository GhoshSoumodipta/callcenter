...
public class EventDTO {
    ...
    @Schema(name = "The automatically generated database id")
    private Long id;

    @Schema(name = "The unique name of the event")
    @NotBlank
    private String name;

    @Schema(name = "The type of the event (THEATER | OPER | FESTIVAL | CONCERT | MOVIE | MUSICAL)")
    private EventType eventType;

    @Schema(name = "A description of the event")
    private String description;

    @Schema(name = "A content of the event")
    private String content;

    @Schema(name = "The duration of the Event")
