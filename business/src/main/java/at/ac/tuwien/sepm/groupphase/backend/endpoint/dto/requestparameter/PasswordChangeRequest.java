...
@Schema(name = "passwordChangeDTO", description = "DTO to pass new user credentials to the backend")
public class PasswordChangeRequest {
    @Schema(requiredMode = RequiredMode.REQUIRED, name = "The password of the user", example = "password")
    private String password;

    @Schema(requiredMode = RequiredMode.REQUIRED, name = "the id of the user", example = "1")
    private Long id;

    @Schema(requiredMode = RequiredMode.REQUIRED, name = "the username of the user", example = "sweetheart93")
