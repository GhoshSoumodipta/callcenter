...
@Schema(name = "AuthenticationRequest", description = "Data Transfer Objects for Authentication Requests via REST")
public class AuthenticationRequest {

	@Schema(requiredMode = RequiredMode.REQUIRED, name = "The unique username of the user", example = "admin")
