...
public enum UserType {
    ...
    public static UserType getTypeByName(String name) {
        return Arrays.stream(UserType.values())
            .filter(enumUserType -> enumUserType.name().equalsIgnoreCase(name))
            .findFirst()
            .orElse(null);
    }

    public UserTypeDTO getDTOByName() {
        return UserTypeDTO.builder().name(name()).build();
