...
@Schema(name = "EventSearchParametersDTO", description = "the parameters to search events for")
public class EventSearchParametersDTO {
    ...
    @NotEmpty
    @Schema(name = "the content of the event")
    private String content;
    @NotBlank
    @Schema(name = "the description of the event")
