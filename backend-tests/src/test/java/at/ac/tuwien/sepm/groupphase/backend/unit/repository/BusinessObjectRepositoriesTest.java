...
public class BusinessObjectRepositoriesTest {
    /*
...
//    @BeforeEach
    ...
    public void testCreateCustomer_Success() throws Exception{
        ...
        EntityBase entity = (EntityBase) ((MapperBase)repositoryBase.mapper()).DTOToEntity(dto);
        System.out.println(dto.toString());
        EntityBase obj = repositoryBase.create(entity);
